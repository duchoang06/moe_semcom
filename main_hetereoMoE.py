...
from utils import text_loss, fix_seed, sample_batch, sample_mixed_task_batch, snr_loss, sample_single_task_batch, collate_fn, SST2Dataset, get_test_loader_for_epoch, moe_balancing_loss, moe_balancing_loss_p_penalty
...
if __name__ == "__main__":
    ...
    torch.save(model.state_dict(), f"./checkpoints/HetereoMoE_decoder_{timestamp}.pt")
...
# nohup python -u main_hetereoMoE.py > ./log/HetereoMoE_decoder_$(date +%Y%m%d_%H%M%S).log 2>&1 & 
